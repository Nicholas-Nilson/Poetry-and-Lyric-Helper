...
def get_exact_matches(word_details: tuple, syllable_count_matches: list) -> list:
    db = database
    # word_details = db.get_word_details(word)
...
def get_close_matches_rhyme(word_details: tuple, syllable_count_matches: list) -> dict:
    db = database
    # word_details = db.get_word_details(word)
...
def get_close_matches_scansion(word_details: tuple, syllable_count_matches) -> dict:
...
test = get_syllables_match_list('automatic')
# print(test)
